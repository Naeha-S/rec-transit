            ...
            <div className="admin-tabs">
              <Tabs defaultValue="allBuses" className="w-full">
                <TabsList className="grid grid-cols-2 md:grid-cols-4 mb-4 h-auto">
                  <TabsTrigger value="allBuses" className="text-sm font-medium py-4 px-2">
                    <span className="hidden sm:inline">All Buses</span>
                    <span className="sm:hidden text-xs">All</span>
                  </TabsTrigger>
                  <TabsTrigger value="tenAm" className="text-sm font-medium py-4 px-2">
                    <span className="hidden sm:inline">10 AM Buses</span>
                    <span className="sm:hidden text-xs">10 AM</span>
                  </TabsTrigger>
                  <TabsTrigger value="fivePm" className="text-sm font-medium py-4 px-2">
                    <span className="hidden sm:inline">5 PM Buses</span>
                    <span className="sm:hidden text-xs">5 PM</span>
                  </TabsTrigger>
                  <TabsTrigger value="exam" className="text-sm font-medium py-4 px-2">
                    <span className="hidden sm:inline">Exam Buses</span>
                    <span className="sm:hidden text-xs">Exam</span>
                  </TabsTrigger>
                </TabsList>
                    ...
                    <Table className="mobile-table">
                      ...
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead className="text-right hidden lg:table-cell">Contact</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        {busData.map((bus) => (
                          <TableRow key={bus.id + "-allbuses"}>
                            ...
                            <TableCell className="hidden sm:table-cell">{bus.routeName}</TableCell>
                            <TableCell className="hidden md:table-cell">{bus.driver}</TableCell>
                            <TableCell className="text-right hidden lg:table-cell">{bus.contactNumber}</TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                    </Table>
                      ...
                      <TableBody>
                        {busData.map((bus) => (
                          <TableRow key={bus.id + "-fivepm"}>
                            ...
                            <TableCell className="font-medium">{bus.busNumber}</TableCell>
                            <TableCell className="hidden sm:table-cell">{bus.routeName.replace('to College', 'from College')}</TableCell>
                      ...
                      >
                        {isExamModeActive ? (
                          <>
                            ...
                            <span className="hidden sm:inline">Disable Exam Mode</span>
                            <span className="sm:hidden">Disable</span>
                          </>
                        ) : (
                          <>
                            <Power className="h-4 w-4" />
                            <span className="hidden sm:inline">Enable Exam Mode</span>
