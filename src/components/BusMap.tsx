  ...
  useEffect(() => {
    ...
    try {
      ...
      filteredBuses.forEach((bus, index) => {
        if (index < 5) { // Limit to 5 buses for demo
          ...
          busMarker.className = `absolute p-1.5 rounded-full flex items-center justify-center transition-all ${selectedRoute === bus.id ? 'bg-college-orange text-white scale-125' : 'bg-college-blue text-white'}`;
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        <div className="text-sm font-medium">{bus.stops[0]?.name}</div>
